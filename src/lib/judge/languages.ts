...
export const DOCKER_IMAGE_RUNTIME_INFO: Record<string, string> = {
  ...
  "judge-intercal:latest": "Debian Bookworm / C-INTERCAL",
  ...
  "judge-unlambda:latest": "Debian Bookworm / Unlambda interpreter",
  "judge-snobol4:latest": "Debian Bookworm / CSNOBOL4",
  "judge-icon:latest": "Debian Bookworm / Icon (Unicon)",
  "judge-simula:latest": "Debian Bookworm / GNU Cim",
...
export const JUDGE_LANGUAGE_CONFIGS: Record<Language, JudgeLanguageDefinition> = {
  ...
  intercal: {
    ...
    standard: null,
    extension: ".i",
    dockerImage: "judge-intercal:latest",
    compiler: "C-INTERCAL (ick)",
    compileCommand: ["ick", "-b", "/workspace/solution.i"],
    runCommand: ["/workspace/solution"],
  },
  k: {
    language: "k",
  ...
  unlambda: {
    ...
    standard: null,
    extension: ".unl",
    dockerImage: "judge-unlambda:latest",
    compiler: null,
    compileCommand: null,
    runCommand: ["unlambda", "/workspace/solution.unl"],
  },
  snobol4: {
    language: "snobol4",
    displayName: "SNOBOL4",
  ...
  simula: {
    ...
    standard: null,
    extension: ".sim",
    dockerImage: "judge-simula:latest",
    compiler: "GNU Cim",
    compileCommand: ["sh", "-c", "cd /workspace && cim /workspace/solution.sim -o /workspace/solution"],
    runCommand: ["/workspace/solution"],
  },
  uiua: {
    language: "uiua",
