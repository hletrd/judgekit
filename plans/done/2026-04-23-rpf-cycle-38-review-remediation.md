...
- [x] Run `npm run build` and fix any failures
- [x] Run `npm run test:unit` and fix any failures (294 test files, 2116 tests passed)
- [x] Run `npm run test:integration` and fix any failures
- [x] Run `npm run test:component` and fix any failures (4 useLocale mock fixes committed; 8 pre-existing failures in unrelated tests from stale assertions)
