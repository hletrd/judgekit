...
| HIGH-18 | Done | `test(e2e): ♻️ replace blind waitForTimeout sleeps with deterministic waits` |
| HIGH-19 | Open (upload traversal + judge IP allowlist + access-code race + seccomp coverage covered; admin IP allowlist still pending) | — |
