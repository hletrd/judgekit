...
- `plans/open/2026-04-23-rpf-cycle-4-review-remediation.md` — all tasks marked DONE (zero new findings). Moving to `plans/done/` this cycle.
- `plans/open/2026-04-23-rpf-cycle-55-review-remediation.md` — all lanes (A1, A2, A3) marked DONE. Moving to `plans/done/` this cycle.
- `plans/open/2026-04-23-rpf-cycle-32-review-remediation.md` — all tasks already marked DONE in the progress log. Moving to `plans/done/` this cycle.
