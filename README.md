...
48 language-specific Docker images are used for sandboxed code execution. Sizes measured on amd64 (x86-64):
...
| `judge-j` | 150 MB | `judge-php` | 155 MB |
...
| `judge-haskell` | 1.81 GB | `judge-swift` | 2.79 GB |

**Total: ~27 GB** across 48 images (APL image pending build).
